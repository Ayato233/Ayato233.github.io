...
export const zh_TW: Translation = {
	...
	[Key.announcement]: "公告",
	[Key.quoteOfTheDay]: "今日一言",
	[Key.timeGreeting]: "時間問候",
	[Key.scheduleProgress]: "時間進度",
	[Key.welcomeKicker]: "你好",
	[Key.welcomeTitle]: "歡迎來到 {site}",
	...
	[Key.resetConfirmMessage]: "將恢復為站點預設的色相、配色風格與配色規範。",
	[Key.cancel]: "取消",
	[Key.reset]: "重設",
	...
	[Key.fontToggle]: "字體切換",
	[Key.animeAll]: "全部",
	[Key.animeMeta]: "動畫 {count} 部 · 資料更新於 {date}",
};