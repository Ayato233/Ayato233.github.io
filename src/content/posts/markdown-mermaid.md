...
本文演示如何使用 Mermaid 在 Markdown 文档中创建各种复杂图表，包括流程图、时序图、甘特图、类图和状态图。
...
要使用 Mermaid，只需在代码块中指定 mermaid 语言，并用简洁的文本语法描述图表即可。Mermaid 会自动将这些描述转换为精美的可视化图表。

在你的下一篇技术博客或项目文档中试试 Mermaid 图表吧——它们会让你的内容更专业、更容易理解！