...
export const site = {
  name: "「时雨」- Shigure de Blog",
  desc: "一场疏雨，如约而至。",
  url: "https://smile32.netlify.app",
  avatar: "https://smile32.netlify.app/images/site/avatar.jpg",
  avatarLocal: "/images/site/avatar.jpg",
  email: "2783885223@qq.com",
};
...
<div class="not-prose my-4">
  <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
    {/* 左栏：本站信息 */}
    <div class="rounded-2xl overflow-hidden flex flex-col bg-[var(--card-bg)] backdrop-blur-md shadow-[var(--card-shadow)]">
        ...
        <div class="flex items-center gap-4 mb-5">
          <div class="relative shrink-0">
            <div class="w-16 h-16 rounded-xl overflow-hidden ring-2 ring-(--primary)/20">
              <img
                src={site.avatarLocal}
                alt={site.name}
                class="w-full h-full object-cover"
                onerror="this.onerror=null;this.src='/images/site/avatar.jpg'"
              />
            </div>
  ...
  {/* 底部：注意事项 */}
  <div class="mt-4 rounded-2xl overflow-hidden bg-[var(--card-bg)] backdrop-blur-md shadow-[var(--card-shadow)]">
