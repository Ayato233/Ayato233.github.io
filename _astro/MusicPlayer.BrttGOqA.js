import"./disclose-version.DwdwGuwu.js";import{B as x,D as k,F as z,H as Ee,J as $,K as ue,L as Le,M as D,N as De,O as ne,P as n,Q as a,R as l,S as ze,T as j,U as de,V as Ie,W as ve,X as Ve,Y as ee,Z as Re,_ as He,b as xe,c as H,d as F,et as Be,f as qe,g as Fe,j as Y,k as S,m as we,p as Ae,q as oe,r as Ke,t as Z,u as _e,v as B,y as ke,z as G}from"./client.BxU0Kc3j.js";import{t as I}from"./Icon.Bq_Z_UXk.js";import{n as J,t as Q}from"./translation.qtJgVbhU.js";import{n as ce}from"./config.DJOsPt9H.js";import{t as _}from"./musicPlayerStore.BGHQnjJa.js";import{a as ge,c as Ne,i as Xe,l as je,n as We,o as Ue,r as Ye,s as Oe,t as Je}from"./SidebarTrackInfo.Dm9NWTD8.js";Ve();function Qe(u){const e=u-1;return e*e*e+1}function pe(u){const e=u-1;return e*e*e+1}function fe(u){const e=typeof u=="string"&&u.match(/^\s*(-?[\d.]+)([^\s]*)\s*$/);return e?[parseFloat(e[1]),e[2]||"px"]:[u,"px"]}function Ze(u,{delay:e=0,duration:t=400,easing:c=pe,x:r=0,y:o=0,opacity:f=0}={}){const d=getComputedStyle(u),p=+d.opacity,i=d.transform==="none"?"":d.transform,g=p*(1-f),[m,y]=fe(r),[b,P]=fe(o);return{delay:e,duration:t,easing:c,css:(s,E)=>`
